        ...
        <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 mr-100 lg:px-8">
          ...
          <div className="mt-10 space-y-5 sm:mx-auto sm:w-full sm:max-w-sm">
              ...
              <div>
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-sm">
                    <a href="/forgot" className="font-semibold underline underline-offset-4 text-grey-600 hover:text-grey-500">
                      Forgot password?
                    </a>
                  </div>
                </div>
            ...
            <p className="flex text-center text-sm py-4  justify-center items-center">
              Don’t have an account? &nbsp; <a href="/register" className="font-semibold leading-6 text-grey">
                 Sign Up
              </a>
            </p>
            <button
