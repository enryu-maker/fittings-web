        ...
        <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 mr-100 lg:px-8">
          ...
          <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <p className="mt-10 text-center text-sm text-gray-500">
              ...
              <a href="#" onClick={handleLogin} className="font-semibold leading-6 text-grey hover:text-indigo-500">
                Sign Up
              </a>
            </p>
            <button
                  type="submit"
                  className="block w-full p-5 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-white-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                   {/* <img
