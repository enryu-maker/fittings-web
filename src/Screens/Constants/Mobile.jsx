    ...
    <div className="flex flex-col md:flex-row items-center justify-center h-screen bg-gray-100">    
      <div className="md:w-1/2 flex flex-col items-center justify-center space-y-4">
        <div className="flex flex-col items-center space-y-2">
          <h2 className="text-black font-bold text-5xl">Get the FittingsWale App</h2><br></br>
         ...
         placeholder="Enter your Email "
          ...
          />
          <button className="px-4 py-2 bg-orange-500 text-white rounded-r-lg hover:bg-black-600">
            Send
          </button>
          </div>
        </div>
        
        <p className="text-lg font-semibold">Download App From</p>
        ...
        <div className="flex space-x-4">
          <a
            ...
            className="flex items-center px-4 py-2 bg-black text-white rounded-lg hover:bg-red-600"
          >
