...
const Terms = () => {
  const sections = [
    {  id:1, title: "Terms & Conditions", description: "Description for Dashboard" },
    { id:2,
      title: "SECTION 1 - ONLINE STORE TERM",
      description:
        "Description for Collection of Personal and Other Information",
    },
    { id:3,title: "SECTION 2 - GENERAL CONDITIONS", description: "Description for Cookies" },
    { id:4,
